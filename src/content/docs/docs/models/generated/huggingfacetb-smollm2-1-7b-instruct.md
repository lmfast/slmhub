...
description: "Discovery-focused notes and runnable examples for `HuggingFaceTB/SmolLM2-1.7B-Instruct`."
---
...
- [🤗 Hugging Face model page](https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct)
- [Model card](https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct#model-card)
