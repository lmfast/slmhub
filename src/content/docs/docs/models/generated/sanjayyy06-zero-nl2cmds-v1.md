...
| Field | Value |
|---|---|
| **Model ID** | `Sanjayyy06/zero-nl2cmds-v1` |
| **Author** | Sanjayyy06 |
| **Pipeline tag** | text-generation |
| **Library** | — |
| **License** | unknown |
| **Last modified** | 2025-10-04T16:43:23+00:00 |
| **Downloads** | 1 |
| **Likes** | 0 |

## Links

- [🤗 Hugging Face model page](https://huggingface.co/Sanjayyy06/zero-nl2cmds-v1)
- [Model card](https://huggingface.co/Sanjayyy06/zero-nl2cmds-v1#model-card)
