...
model_id = "TheBloke/CodeUp-Llama-2-13B-Chat-HF-GGML"
...
```bash
ollama run codeup-llama-2-13b-chat-hf-ggml
```
...
| Field | Value |
|---|---|
| **Model ID** | `TheBloke/CodeUp-Llama-2-13B-Chat-HF-GGML` |
| **Author** | TheBloke |
| **Pipeline tag** | — |
...
- [🤗 Hugging Face model page](https://huggingface.co/TheBloke/CodeUp-Llama-2-13B-Chat-HF-GGML)
- [Model card](https://huggingface.co/TheBloke/CodeUp-Llama-2-13B-Chat-HF-GGML#model-card)
