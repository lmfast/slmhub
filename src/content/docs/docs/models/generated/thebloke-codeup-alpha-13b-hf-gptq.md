...
model_id = "TheBloke/CodeUp-Alpha-13B-HF-GPTQ"
...
```bash
ollama run codeup-alpha-13b-hf-gptq
```
...
| Field | Value |
|---|---|
| **Model ID** | `TheBloke/CodeUp-Alpha-13B-HF-GPTQ` |
| **Author** | TheBloke |
...
- [🤗 Hugging Face model page](https://huggingface.co/TheBloke/CodeUp-Alpha-13B-HF-GPTQ)
- [Model card](https://huggingface.co/TheBloke/CodeUp-Alpha-13B-HF-GPTQ#model-card)
