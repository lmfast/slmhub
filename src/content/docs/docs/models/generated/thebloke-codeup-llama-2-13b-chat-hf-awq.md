...
model_id = "TheBloke/CodeUp-Llama-2-13B-Chat-HF-AWQ"
...
```bash
ollama run codeup-llama-2-13b-chat-hf-awq
```
...
| Field | Value |
|---|---|
| **Model ID** | `TheBloke/CodeUp-Llama-2-13B-Chat-HF-AWQ` |
| **Author** | TheBloke |
...
- [🤗 Hugging Face model page](https://huggingface.co/TheBloke/CodeUp-Llama-2-13B-Chat-HF-AWQ)
- [Model card](https://huggingface.co/TheBloke/CodeUp-Llama-2-13B-Chat-HF-AWQ#model-card)
