...
model_id = "TheBloke/CodeUp-Alpha-13B-HF-AWQ"
...
```bash
ollama run codeup-alpha-13b-hf-awq
```
...
| Field | Value |
|---|---|
| **Model ID** | `TheBloke/CodeUp-Alpha-13B-HF-AWQ` |
| **Author** | TheBloke |
...
- [🤗 Hugging Face model page](https://huggingface.co/TheBloke/CodeUp-Alpha-13B-HF-AWQ)
- [Model card](https://huggingface.co/TheBloke/CodeUp-Alpha-13B-HF-AWQ#model-card)
