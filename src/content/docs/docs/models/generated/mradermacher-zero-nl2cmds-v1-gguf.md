...
model_id = "mradermacher/zero-nl2cmds-v1-GGUF"
...
```bash
ollama run zero-nl2cmds-v1-gguf
```
...
| Field | Value |
|---|---|
| **Model ID** | `mradermacher/zero-nl2cmds-v1-GGUF` |
| **Author** | mradermacher |
| **Pipeline tag** | — |
...
- [🤗 Hugging Face model page](https://huggingface.co/mradermacher/zero-nl2cmds-v1-GGUF)
- [Model card](https://huggingface.co/mradermacher/zero-nl2cmds-v1-GGUF#model-card)
