...
model_id = "mradermacher/CodeUp-Llama-3-8B-GGUF"
...
```bash
ollama run codeup-llama-3-8b-gguf
```
...
| Field | Value |
|---|---|
| **Model ID** | `mradermacher/CodeUp-Llama-3-8B-GGUF` |
| **Author** | mradermacher |
| **Pipeline tag** | — |
| **Library** | transformers |
| **License** | unknown |
| **Last modified** | 2025-07-11T06:38:55+00:00 |
| **Downloads** | 8 |
| **Likes** | 2 |

## Links

- [🤗 Hugging Face model page](https://huggingface.co/mradermacher/CodeUp-Llama-3-8B-GGUF)
- [Model card](https://huggingface.co/mradermacher/CodeUp-Llama-3-8B-GGUF#model-card)
