...
model_id = "juyongjiang/CodeUp-Llama-2-13b-chat-hf"
...
```bash
ollama run codeup-llama-2-13b-chat-hf
```
...
| Field | Value |
|---|---|
| **Model ID** | `juyongjiang/CodeUp-Llama-2-13b-chat-hf` |
| **Author** | juyongjiang |
...
- [🤗 Hugging Face model page](https://huggingface.co/juyongjiang/CodeUp-Llama-2-13b-chat-hf)
- [Model card](https://huggingface.co/juyongjiang/CodeUp-Llama-2-13b-chat-hf#model-card)
