...
model_id = "remiai3/text-to-code-using-codegen-project_guide"
...
```bash
ollama run text-to-code-using-codegen-project_guide
```
...
| Field | Value |
|---|---|
| **Model ID** | `remiai3/text-to-code-using-codegen-project_guide` |
| **Author** | remiai3 |
| **Pipeline tag** | — |
| **Library** | transformers |
| **License** | unknown |
| **Last modified** | 2025-08-02T15:58:42+00:00 |
| **Downloads** | 0 |
| **Likes** | 0 |

## Links

- [🤗 Hugging Face model page](https://huggingface.co/remiai3/text-to-code-using-codegen-project_guide)
- [Model card](https://huggingface.co/remiai3/text-to-code-using-codegen-project_guide#model-card)
